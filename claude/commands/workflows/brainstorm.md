...
- Task conventions-researcher("Discover project conventions and patterns related to: <feature_description>")
- Task code-flow-researcher("Understand code structure and execution flow related to: <feature_description>")
