...
**1. In-session execution** - Execute task-by-task in this session with review checkpoints

**2. Separate session execution** - Open a new session and execute the plan there in batches with checkpoints
